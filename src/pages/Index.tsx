...
import { ArrowRight, Shield, Zap, CreditCard, Users, Clock, CheckCircle2, Wallet, Globe } from 'lucide-react';
...
const Index = () => {
  const features = [
    ...
    { icon: CreditCard, title: 'Virtual Cards', desc: 'Create virtual Naira cards for online payments and subscriptions.' },
    { icon: Wallet, title: 'Virtual Account', desc: 'Get a dedicated Nigerian virtual account in your name via Flutterwave.' },
    { icon: Zap, title: 'Instant Processing', desc: 'Payments processed in real-time through Flutterwave infrastructure.' },
    { icon: Globe, title: 'BVN Verified', desc: 'Every user is BVN-verified for secure, compliant transactions.' },
  ];
      ...
      <section className="page-container pt-16 pb-24 sm:pt-24 sm:pb-32">
        <div className="max-w-2xl section-reveal">
          ...
          <p className="text-lg text-muted-foreground max-w-xl leading-relaxed mb-8">
            Automate salary disbursement, create virtual cards, schedule payments, and manage your workforce payroll — all from one platform. Powered by Flutterwave.
          </p>
